...
title: Biodiversity Credits FAQ
---
...
- Token issued as `NC-BIO-{ID}` (ERC-7943 uRWA)
...
1. **UK mandatory BNG** (effective February 2024) — all major planning applications must deliver a minimum 10% biodiversity net gain using the statutory metric
2. **EU Nature Restoration Law** (effective 2024) — binding restoration targets across 30% of degraded EU habitats
3. **Kunming-Montreal GBF** — 196 signatory nations committed to 30×30 and financing the biodiversity gap
