...
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"1rem",margin:"1.5rem 0"}}>
  <div style={{background:"linear-gradient(135deg,#f0fdf4,#eff6ff)",border:"1px solid #bbf7d0",borderRadius:"0.75rem",padding:"1.25rem"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>📜</div>
    <div style={{fontWeight:600,marginBottom:"0.25rem"}}>Submit Certificates</div>
    <div style={{fontSize:"0.875rem",color:"#6b7280"}}>Upload RWA certificates with full metadata and documentation across multiple asset types</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#f0fdf4,#eff6ff)",border:"1px solid #bbf7d0",borderRadius:"0.75rem",padding:"1.25rem"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>✅</div>
    <div style={{fontWeight:600,marginBottom:"0.25rem"}}>3-of-5 Multi-Sig</div>
    <div style={{fontSize:"0.875rem",color:"#6b7280"}}>Certificates require approval from 3 of 5 authorized governance members before tokens are minted</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#f0fdf4,#eff6ff)",border:"1px solid #bbf7d0",borderRadius:"0.75rem",padding:"1.25rem"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>📊</div>
    <div style={{fontWeight:600,marginBottom:"0.25rem"}}>Track Status</div>
    <div style={{fontSize:"0.875rem",color:"#6b7280"}}>Monitor approval progress, quality scores, and tokenization status in real time</div>
  </div>
</div>
