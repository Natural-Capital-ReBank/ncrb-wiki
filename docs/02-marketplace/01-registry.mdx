...
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"1rem",margin:"1.5rem 0"}}>
  <div style={{background:"linear-gradient(135deg,#14532d,#1e3a5f)",borderRadius:"12px",padding:"1.5rem",border:"1px solid #16a34a"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.75rem"}}>📜</div>
    <div style={{color:"#bbf7d0",fontWeight:"700",marginBottom:"0.5rem"}}>Submit Certificates</div>
    <div style={{color:"#86efac",fontSize:"0.875rem"}}>Upload RWA certificates with full metadata and documentation across multiple asset types</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#1e3a5f,#14532d)",borderRadius:"12px",padding:"1.5rem",border:"1px solid #15803d"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.75rem"}}>✅</div>
    <div style={{color:"#bfdbfe",fontWeight:"700",marginBottom:"0.5rem"}}>3-of-5 Multi-Sig</div>
    <div style={{color:"#93c5fd",fontSize:"0.875rem"}}>Certificates require approval from 3 of 5 authorized governance members before tokens are minted</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#064e3b,#1e3a5f)",borderRadius:"12px",padding:"1.5rem",border:"1px solid #059669"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.75rem"}}>📊</div>
    <div style={{color:"#a7f3d0",fontWeight:"700",marginBottom:"0.5rem"}}>Track Status</div>
    <div style={{color:"#6ee7b7",fontSize:"0.875rem"}}>Monitor approval progress, quality scores, and tokenization status in real time</div>
  </div>
</div>
...
```mermaid
flowchart TD
    A([Registry submits certificate]) --> B[Oracle API computes quality score 0–100]
    B --> C{3-of-5 Registry\nmembers vote}
    C --> D[Certificate enters Governance queue]
    D --> E{3-of-5 Governance\nmembers vote}
    E --> F([Tokens minted and distributed])
    E --> G([Rejected / Expired])
    F --> H([Certificate available on marketplace])
```
...
<YouTubeEmbed id="KICTL4MMM-Y" title="Registry - Submit Certificate" />
