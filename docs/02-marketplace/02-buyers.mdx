...
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"1rem",margin:"1.5rem 0"}}>
  <div style={{background:"linear-gradient(135deg,#134e4a,#1e3a5f)",borderRadius:"12px",padding:"1.5rem",border:"1px solid #0d9488"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.75rem"}}>🌍</div>
    <div style={{color:"#99f6e4",fontWeight:"700",marginBottom:"0.5rem"}}>Browse & Filter</div>
    <div style={{color:"#5eead4",fontSize:"0.875rem"}}>Explore listings by asset type, country, SDG goals, quality band, and price — no wallet required</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#1e3a5f,#134e4a)",borderRadius:"12px",padding:"1.5rem",border:"1px solid #0e7490"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.75rem"}}>⚡</div>
    <div style={{color:"#bae6fd",fontWeight:"700",marginBottom:"0.5rem"}}>Instant On-Chain Purchase</div>
    <div style={{color:"#7dd3fc",fontSize:"0.875rem"}}>Buy verified RWA credits instantly with USDC — settlement happens in a single on-chain transaction</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#0c4a6e,#134e4a)",borderRadius:"12px",padding:"1.5rem",border:"1px solid #0369a1"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.75rem"}}>🏆</div>
    <div style={{color:"#a5f3fc",fontWeight:"700",marginBottom:"0.5rem"}}>Retire & Claim</div>
    <div style={{color:"#67e8f9",fontSize:"0.875rem"}}>Retire credits on-chain to generate a permanent, auditable proof of your environmental action</div>
  </div>
</div>
