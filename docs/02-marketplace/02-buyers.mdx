...
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"1rem",margin:"1.5rem 0"}}>
  <div style={{background:"linear-gradient(135deg,#f0fdfa,#eff6ff)",border:"1px solid #99f6e4",borderRadius:"0.75rem",padding:"1.25rem"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>🌍</div>
    <div style={{fontWeight:600,marginBottom:"0.25rem"}}>Browse & Filter</div>
    <div style={{fontSize:"0.875rem",color:"#6b7280"}}>Explore listings by asset type, country, SDG goals, quality band, and price — no wallet required</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#f0fdfa,#eff6ff)",border:"1px solid #99f6e4",borderRadius:"0.75rem",padding:"1.25rem"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>⚡</div>
    <div style={{fontWeight:600,marginBottom:"0.25rem"}}>Instant On-Chain Purchase</div>
    <div style={{fontSize:"0.875rem",color:"#6b7280"}}>Buy verified RWA credits instantly with USDC — settlement happens in a single on-chain transaction</div>
  </div>
  <div style={{background:"linear-gradient(135deg,#f0fdfa,#eff6ff)",border:"1px solid #99f6e4",borderRadius:"0.75rem",padding:"1.25rem"}}>
    <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>🏆</div>
    <div style={{fontWeight:600,marginBottom:"0.25rem"}}>Retire & Claim</div>
    <div style={{fontSize:"0.875rem",color:"#6b7280"}}>Retire credits on-chain to generate a permanent, auditable proof of your environmental action</div>
  </div>
</div>
